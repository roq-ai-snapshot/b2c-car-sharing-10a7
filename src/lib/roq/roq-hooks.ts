...
export function useOperationsStaffFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsStaffFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations_staff.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsStaffCount<T extends Prisma.operations_staffCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.operations_staffCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsStaffCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations_staff.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsStaffFindManyWithCount<
  T extends Prisma.operations_staffFindManyArgs,
  R extends { data: GetFindResult<Prisma.$operations_staffPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.operations_staffFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsStaffFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations_staff.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsStaffFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsStaffFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations_staff.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
