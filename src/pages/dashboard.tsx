...
import { useRoqPlatformUserProfiles, useCarCount, useBookingCount, useOperationsStaffCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const operationsStaffStat = useOperationsStaffCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: operationsStaffStat?.data,
      isLoading: operationsStaffStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
