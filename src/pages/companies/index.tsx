...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'car.count', 'operations_staff.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('car', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('operations_staff', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'operations_staff',
          header: 'Operations Staff',
          accessorKey: 'operations_staff',
          cell: ({ row: { original: record } }: any) => record?._count?.operations_staff,
        }
      : null,
